...
#define MESH_OOB_INFO_SIZE                          2

#define MESH_SEC_BEACON_AUTH_SIZE                   8

#define MESH_SEC_BEACON_AUTH_OFFSET                 13
...
#if 0
/** Unassigned address. */
#define MESH_ADDR_UNASSIGNED                  (0xFFFF)
 ...
 */
#define MESH_OPCODE_IS_SIZE_ONE(opcode)            ((opcode[0] & 0x80) == 0)
 ...
 *  \remarks Do not use directly. Use ::MESH_OPCODE_SIZE instead
 */
#define MESH_OPCODE_MSBITS_TO_SIZE(opcode)         ((opcode[0] & 0xC0) >> 6)
...
#define MESH_OPCODE_IS_VALID(opcode)               (!(opcode[0] == 0x7F))
