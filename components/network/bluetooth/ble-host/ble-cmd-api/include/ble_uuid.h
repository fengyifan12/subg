...
/** @file
 *
 * @brief BLE UUID header file.
 *
 */

/**
 * @defgroup ble_common_uuid BLE UUID Definitions.
 * @ingroup ble_common
 * @details This file shows the common BLE UUID definitions.
 * @{
 * @brief Define BLE common UUID definitions.
 * @}
 */
 ...
 *************************************************************************************************/
/**
 * @defgroup ble_service_uuid BLE GATT Service UUIDs.
 * @{
 * @ingroup ble_common_uuid
...
/**
 * @defgroup ble_char_uuid BLE GATT Characteristic UUIDs.
 * @{
 * @ingroup ble_common_uuid
...
#define GATT_SPEC_CHARC_MESH_PROVISIONING_DATA_IN                       0x2ADB    /**< Mesh Provisioning Data In Characteristic UUID. */
#define GATT_SPEC_CHARC_MESH_PROVISIONING_DATA_OUT                      0x2ADC    /**< Mesh Provisioning Data Out Characteristic UUID. */
#define GATT_SPEC_CHARC_MESH_PROXY_DATA_IN                              0x2ADD    /**< Mesh Proxy Data In Characteristic UUID. */
#define GATT_SPEC_CHARC_MESH_PROXY_DATA_OUT                             0x2ADE    /**< Mesh Proxy Data Out Characteristic UUID. */
/** @} */


/**
 * @defgroup ble_decl_uuid BLE GATT Descriptors UUIDs.
 * @{
 * @ingroup ble_common_uuid
...
/**
 * @defgroup ble_unit_uuid BLE Unit UUIDs.
 * @{
 * @ingroup ble_common_uuid
