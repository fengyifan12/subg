...
/**
 * \defgroup ECJPAKE ECJPAKE
 * \ingroup RT58X_DRIVER
 * \brief  Define ECJPAKE definitions, structures, and functions
 * @{
 */
...
/*@}*/ /* end of RT58X_DRIVER CRYPTO_UTIL_H */

#ifdef __cplusplus
}
#endif

#endif  /* end of _INCLUDE_ECJPAKE_ECC256_DEFINE_ */
