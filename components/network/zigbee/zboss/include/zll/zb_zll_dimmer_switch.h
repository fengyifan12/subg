...
#ifndef ZB_ZLL_DIMMER_SWITCH_H
#define ZB_ZLL_DIMMER_SWITCH_H 1

#define ZB_ZLL_DEVICE_VER_DIMMER_SWITCH 0  /*!< Dimmer Switch device version */


#define ZB_ZLL_DIMMER_SWITCH_IN_CLUSTER_NUM 2  /*!< Dimmer Switch IN (server) clusters number */
#define ZB_ZLL_DIMMER_SWITCH_OUT_CLUSTER_NUM 5 /*!< Dimmer Switch OUT (client) clusters number */

#define ZB_ZLL_DIMMER_SWITCH_DEVICE_ID 0xc05e
/** Dimmer switch total (IN+OUT) cluster number */
#define ZB_ZLL_DIMMER_SWITCH_CLUSTER_NUM                                             \
  (ZB_ZLL_DIMMER_SWITCH_IN_CLUSTER_NUM + ZB_ZLL_DIMMER_SWITCH_OUT_CLUSTER_NUM)

/*! Number of attribute for reporting on Dimmer Switch device */
#define ZB_ZLL_DIMMER_SWITCH_REPORT_ATTR_COUNT         0
 ...
 */
#define ZB_ZLL_DECLARE_DIMMER_SWITCH_CLUSTER_LIST(  \
    cluster_list_name,                                    \
    basic_attr_list,                                      \
    identify_attr_list)                                   \
...
#define ZB_ZCL_DECLARE_DIMMER_SWITCH_SIMPLE_DESC(                             \
  ...
  {                                                                           \
    ...
    ZB_ZLL_DIMMER_SWITCH_DEVICE_ID,                                           \
    ZB_ZLL_DEVICE_VER_DIMMER_SWITCH,                                          \
    0,                                                                        \
    in_clust_num,                                                             \
    out_clust_num,                                                            \
    {                                                                         \
 ...
 */
#define ZB_ZLL_DECLARE_DIMMER_SWITCH_EP(ep_name, ep_id, cluster_list)                           \
...
#define ZB_ZLL_DECLARE_DIMMER_SWITCH_CTX(device_ctx, ep_name) \
  ZBOSS_DECLARE_DEVICE_CTX_1_EP(device_ctx, ep_name)

/*! @} */

#endif /* ZB_ZLL_DIMMER_SWITCH_H */
