 ...
 * @ingroup hci_event
 */
extern ble_err_t (* const host_prcss_hci_event[])(uint8_t *p_data, uint8_t length);
extern ble_err_t prcss_hci_vendor_event(uint8_t *p_data, uint8_t length);
...
typedef struct __attribute__((packed))
{
    ...
    union __attribute__((packed))
    {
        ...
        ble_hci_return_param_set_default_phy_t                      default_phy;
