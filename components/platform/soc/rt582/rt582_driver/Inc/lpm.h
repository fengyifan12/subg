...
#define COMMUMICATION_SUBSYSTEM_DIS_HOSTMODE    (1 << 25)       /*!< Subsystem disable host mode shift */
...
#define LPM_DEEP_SLEEP                          LOW_POWER_LEVEL_SLEEP3

/**
 * \brief           Platfrom sleep mode definition
 */
typedef enum {
    LOW_POWER_PLATFORM_ENTER_SLEEP = (1 << 0),      /*!< platform system
                                                     enter sleep mode */
    LOW_POWER_PLATFORM_ENTER_DEEP_SLEEP = (1 << 1), /*!< platform system
                                                     enter deep sleep mode */
} low_power_platform_enter_mode_cfg_t;

/**
 * \brief           Platfrom power level definition
 */
typedef enum {
    LOW_POWER_LEVEL_NORMAL = 0,                 /**< platform system: run, 
                                                 communication system: run */
    LOW_POWER_LEVEL_SLEEP0,                     /**< platform system: sleep,
                                                 communication system: run */
    LOW_POWER_LEVEL_SLEEP1,                     /**< platform system: sleep,
                                                 communication system: sleep */
    LOW_POWER_LEVEL_SLEEP2,                     /**< platform system: sleep,
                                                 communication system: deep sleep */
    LOW_POWER_LEVEL_SLEEP3,                     /**< platform system: deep 
                                                 sleep, communication system: deep sleep */
...
/**
 * \brief           Platfrom wake up source definition
 */
typedef enum {
    LOW_POWER_WAKEUP_NULL = (0), /**< Low power mode wake-up source: Null */

    LOW_POWER_WAKEUP_RTC_TIMER =
        ((1 << 0) & 0xFFFF), /**< Low power mode wake-up source: RTC Timer */
    LOW_POWER_WAKEUP_GPIO =
        ((1 << 1) & 0xFFFF), /**< Low power mode wake-up source: GPIO */
    LOW_POWER_WAKEUP_COMPARATOR =
        ((1 << 2)
         & 0xFFFF), /**< Low power mode wake-up source: Analog Comparator */
    LOW_POWER_WAKEUP_SLOW_TIMER =
        ((1 << 3) & 0xFFFF), /**< Low power mode wake-up source: 32KHz Timers */
    LOW_POWER_WAKEUP_UART_RX =
        ((1 << 4)
         & 0xFFFF), /**< Low power mode wake-up source: UART Rx Break Signal */

    LOW_POWER_WAKEUP_GPIO0 =
        ((0 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO0 */
    LOW_POWER_WAKEUP_GPIO1 =
        ((1 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO1 */
    LOW_POWER_WAKEUP_GPIO2 =
        ((2 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO2 */
    LOW_POWER_WAKEUP_GPIO3 =
        ((3 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO3 */
    LOW_POWER_WAKEUP_GPIO4 =
        ((4 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO4 */
    LOW_POWER_WAKEUP_GPIO5 =
        ((5 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO5 */
    LOW_POWER_WAKEUP_GPIO6 =
        ((6 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO6 */
    LOW_POWER_WAKEUP_GPIO7 =
        ((7 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO7 */
    LOW_POWER_WAKEUP_GPIO8 =
        ((8 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO8 */
    LOW_POWER_WAKEUP_GPIO9 =
        ((9 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO9 */
    LOW_POWER_WAKEUP_GPIO10 =
        ((10 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO10 */
    LOW_POWER_WAKEUP_GPIO11 =
        ((11 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO11 */
    LOW_POWER_WAKEUP_GPIO12 =
        ((12 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO12 */
    LOW_POWER_WAKEUP_GPIO13 =
        ((13 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO13 */
    LOW_POWER_WAKEUP_GPIO14 =
        ((14 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO14 */
    LOW_POWER_WAKEUP_GPIO15 =
        ((15 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO15 */
    LOW_POWER_WAKEUP_GPIO16 =
        ((16 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO16 */
    LOW_POWER_WAKEUP_GPIO17 =
        ((17 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO17 */
    LOW_POWER_WAKEUP_GPIO18 =
        ((18 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO18 */
    LOW_POWER_WAKEUP_GPIO19 =
        ((19 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO19 */
    LOW_POWER_WAKEUP_GPIO20 =
        ((20 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO20 */
    LOW_POWER_WAKEUP_GPIO21 =
        ((21 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO21 */
    LOW_POWER_WAKEUP_GPIO22 =
        ((22 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO22 */
    LOW_POWER_WAKEUP_GPIO23 =
        ((23 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO23 */
    LOW_POWER_WAKEUP_GPIO24 =
        ((24 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO24 */
    LOW_POWER_WAKEUP_GPIO25 =
        ((25 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO25 */
    LOW_POWER_WAKEUP_GPIO26 =
        ((26 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO26 */
    LOW_POWER_WAKEUP_GPIO27 =
        ((27 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO27 */
    LOW_POWER_WAKEUP_GPIO28 =
        ((28 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO28 */
    LOW_POWER_WAKEUP_GPIO29 =
        ((29 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO29 */
    LOW_POWER_WAKEUP_GPIO30 =
        ((30 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO30 */
    LOW_POWER_WAKEUP_GPIO31 =
        ((31 << 16)
         | LOW_POWER_WAKEUP_GPIO), /**< Low power mode wake-up source: GPIO31 */

    LOW_POWER_WAKEUP_UART0_RX =
        ((0 << 16)
         | LOW_POWER_WAKEUP_UART_RX), /**< Low power mode wake-up source: UART0 Rx Break Signal */
    LOW_POWER_WAKEUP_UART1_RX =
        ((1 << 16)
         | LOW_POWER_WAKEUP_UART_RX), /**< Low power mode wake-up source: UART1 Rx Break Signal */
    LOW_POWER_WAKEUP_UART2_RX =
        ((2 << 16)
         | LOW_POWER_WAKEUP_UART_RX), /**< Low power mode wake-up source: UART2 Rx Break Signal */
...
/**
 * \brief            sub system sram deep sleep init
 */
